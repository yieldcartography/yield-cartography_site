...
% 7 ---------------------------------------------------------------------------
\begin{frame}{Result 1: the survey wins at one year}
  \kicker{The short end of the horizon grid}
  \bignum{1.62}{MSE ratio (model over survey) at $h=12$ months, DM $p=0.002$
  in the survey's favour, and encompassing finds the survey adds information
  beyond the model. Respondents observe high-frequency news and policy
  guidance between the model's calibration dates.}
\end{frame}
...
\begin{frame}{Interpretation}
  ...
  \small
  \begin{itemize}
    \item The two expectation measures are not rivals over the whole grid but
          specialists by horizon: news and guidance dominate within a year,
          the no-arbitrage restriction dominates beyond two.
    ...
    \item Conversely, the one-year result cautions against reading short-run
          model-survey gaps as mispricing: at that horizon the survey is the
          better-informed object.
  \end{itemize}
\end{frame}
